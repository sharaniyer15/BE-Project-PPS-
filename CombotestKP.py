...
X_feature= SelectKBest(chi2, k=3).fit_transform(Xt,Y2)
print(X_feature.shape)
print(X_feature)
X_feature=pd.DataFrame(X_feature, columns=columns_new1)
...
X_feature1= SelectKBest(chi2, k=3).fit_transform(Xt2,Y3)
print(X_feature1.shape)
#print(X_feature)
X_feature1=pd.DataFrame(X_feature1, columns=columns_new1)
print(X_feature1)
#print(Y2)
...
for max_depth in [1,2,3,4,5]:
      for max_leaf_nodes in [4,6,7,8,9]:
