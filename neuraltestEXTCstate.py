...
data1 = pd.read_csv("F:/DTC/SSC-HSC_EXTC_11-12.csv", sep = ",")
X1 =  data1.iloc[:,1:9]
y1 = data1.iloc[:,9]
Y1 = y1.to_frame()  
...
data2 = pd.read_csv("F:/DTC/SSC-HSC_EXTC_12-13.csv", sep = ",")
X2 = data2.iloc[:,1:9]
y2 = data2.iloc[:,9]
Y2 = y2.to_frame()
...
data3 = pd.read_csv("F:/DTC/SSC-HSC_EXTC_13-14.csv", sep = ",")
X3 = data3.iloc[:,1:9]
y3 = data3.iloc[:,9]
Y3 = y3.to_frame()
...
data4 = pd.read_csv("F:/DTC/SSC-HSC_EXTC_14-15.csv", sep = ",")
X4 = data4.iloc[:,1:9]
y4 = data4.iloc[:,9]
Y4 = y4.to_frame()
